...
var Parser = function(opts) {
    ...
    this.separator = fs; // field separator/delimiter character
    this.newline = lf; // new line character

    this.headers = null; // field names for current line
...
Parser.prototype._online = function(buf, start, end) {
    ...
    // compile the Row clas with field names for the form type and filing version

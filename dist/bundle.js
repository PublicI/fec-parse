(function (global, factory) {
  ...
  (global = global || self, global.FECParse = factory());
  ...
  var mappings$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': mappings
  });

  var renderedMaps = getCjsExportFromNamespace(mappings$1);
  ...
  */
  ...
  inherits$2(Parser, Stream.Transform);
  ...
  */
  ...
  Parser.prototype._lookup = function(type,version) {
      ...
      res.headers = mappings$2.lookup(type,version);
  ...
  */
  ...
  Parser.prototype._compile = function(headers) {
      ...
      var Row = generateFunction()('function Row (cells) {');

      headers.forEach(function(cell, i) {
          Row('%s = cells[%d]', generateObjectProperty('this', cell), i);
      });
